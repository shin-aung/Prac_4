...
INITIAL_NUMBER = 9
numbers_greater_than_nine = [number for number in numbers if number > INITIAL_NUMBER]
...
last_names_of_full_names_longer_than_eleven_characters = [full_name.split()[1] for full_name in full_names if len(full_name) > 11]
print(last_names_of_full_names_longer_than_eleven_characters)
full_names = ["Bob Martin", "Angel Harlem", "Jimi Hendrix", "Alan Turing", "Ada Lovelace"]